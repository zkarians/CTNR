...
function isUltraLowHeightProduct(p, orientedH) {
...
function getStackedCount(x, y, w, l, placedItems) {
    ...
    for (var _i = 0, placedItems_1 = placedItems; _i < placedItems_1.length; _i++) {
        ...
        if (!isLowHeightProduct(item.product, item.h) || isUltraLowHeightProduct(item.product, item.h))
            continue;
                    ...
                    for (var bW = 1; bW <= Math.min(5, unpacked.get(p.id)); bW++) {
                        for (var bL = 1; bL <= 5; bL++) {
                            ...
                            var _loop_2 = function (hCount) {
                                ...
                                var layStackCount = o.type === 'lay' ? hCount : 0;
                                var zPossible = o.type !== 'lay' || layStackCount < 2;
                                while (curZ < H && zPossible) {
                                    ...
                                    if (bestRowItems.length > 0) {
                                        ...
                                        if (bestRowItems[0].orientation === 'lay')
                                            layStackCount++;
