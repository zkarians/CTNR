...
const regex = /if \(editingReportItem\) \{[\s\S]*?existingCntrs\.splice\(insertIdx, 0, newRawContainer\);\s*\}/;
...
if (regex.test(content)) {
    ...
    console.log("Regex patch in HomeClient.tsx completed.");
} else {
    console.log("Regex not found in HomeClient.tsx.");
}
